...
function HowWorks() {
    ...
    return (
        <div className='py-16 md:py-30 bg-dark-secondary'>
            <div className='max-w-328 mx-auto max-[1350px]:px-4'>
                ...
                <div className='flex flex-col gap-6 lg:flex-row md:items-center lg::justify-between mt-4'>
...
//     return (
//         <div className='py-30 bg-dark-secondary'>
//             <div className='max-w-328 mx-auto max-[1350px]:px-4'>
//                 <p data-aos="fade-up" className='font-jost font-medium text-xs text-gray-primary leading-150 tracking-20 uppercase'>How It Works</p>
//                 <div className='flex items-center justify-between mt-4'>
//                     <h2 data-aos="fade-right" data-aos-delay="150" className='font-cormorant font-normal text-custom-6xl leading-120 tracking-normal text-white max-w-133.25'>A process built on <span className='italic'>trust</span> and transparency.</h2>
//                     <p data-aos="fade-left" data-aos-delay="150" className='mt-auto max-w-133.25 font-jost font-normal text-base leading-150 tracking-normal text-white/60'>We've refined our approach over three decades to make the custom home building process as clear and stress-free as possible — from first conversation to move-in day.</p>
//                 </div>
//                 <div className='flex items-center mt-15'>
//                     {HOW_WORKS_DATA.map((item, i) => (
//                         <div
//                             key={i}
//                             className='p-8 border border-white/12 bg-black-soft max-w-82'
//                             data-aos="zoom-in"
//                             data-aos-delay={i * 150}
//                         >
//                             <span className='font-cormorant font-normal text-custom-6xl leading-120 tracking-normal text-white/12'>{item.count}</span>
