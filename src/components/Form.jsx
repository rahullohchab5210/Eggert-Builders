    ...
    return (
        <div className='border border-gray-light bg-offwhite py-16 md:py-30'>
            <div className='max-w-216.5 mx-auto px-4 md:px-6'>
                <h2 data-aos="fade-up" className='pb-10 md:pb-15 font-cormorant font-normal text-4xl md:text-5xl text-custom-6xl leading-120 tracking-normal text-center text-dark-primary'>
                ...
                <div className='flex flex-col gap-6 w-full'>
                    ...
                    <div data-aos="fade-up" data-aos-delay="150" className='flex flex-col lg:flex-row lg:gap-4 gap-6 w-full'>
                        <div className='border-b border-b-gray-light flex flex-col gap-3 pb-3 w-full'>
                            <label className='font-jost font-medium text-xs leading-150 tracking-20 uppercase text-dark-primary'>
                                First Name
                            </label>
                            <Input
                                type="text"
                ...
                <div data-aos="fade-up" data-aos-delay="650" className='flex items-center justify-center'>
                    <Button className='mt-10 md:mt-15 py-3.25 px-5.5 bg-dark-primary'
                        text={"send message"}
                        onClick={submit}
                    />
                </div>
...
//     return (
//         <div className='border border-gray-light bg-offwhite py-30'>
//             <div className='max-w-216.5 mx-auto'>
//                 <h2 data-aos="fade-up" className='pb-15 font-cormorant font-normal text-custom-6xl leading-120 tracking-normal text-center text-dark-primary'>
//                     Let's build something <span className='italic'>together.</span>
//                 </h2>

//                 <div className='flex flex-col gap-6 w-full'>

//                     <div data-aos="fade-up" data-aos-delay="150" className='flex gap-4 w-full'>
//                         <div className='border-b border-b-gray-light flex flex-col gap-3 pb-3 min-w-[425px]'>
//                             <label className='font-jost font-medium text-xs leading-150 tracking-20 uppercase text-dark-primary'>
//                                 First Name
//                             </label>
//                             <Input
...
//                 </div>
//                 <div data-aos="fade-up" data-aos-delay="650" className='flex items-center justify-center'>
//                     <Button className='mt-15 py-3.25 px-5.5 bg-dark-primary'
//                         text={"send message"}
//                         onClick={submit}
//                     />
//                 </div>
