                        ...
                        <div className='flex flex-col gap-6 pt-8'>
                            {ADDRESS_DATA.map((item, i) => (
                                <div key={i} data-aos="fade-up" data-aos-delay={400 + i * 100}>
                                    ...
                                    <p className='pt-1 font-jost font-normal sm:text-base text-sm leading-150 tracking-normal text-white'>{item.description}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                    <div data-aos="fade-left" data-aos-delay="200" className='w-full lg:h-180.25 sm:h-125 h-100 lg:max-w-221.25'>
                        <iframe
